...
$id = $_POST['anni'];
	...
	$query1 = "UPDATE tb_announcements SET ann_photo='images/$file_name' WHERE anid = '$id'";

	if(mysql_query($query1)) {
	
	echo "<script>alert('Update successfully!...','self');window.location='adminannounce.php';</script>";

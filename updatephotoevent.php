...
$id = $_POST['eeid'];
	...
	$query1 = "UPDATE tb_events SET event_photo='images/$file_name' WHERE eid = '$id'";

	if(mysql_query($query1)) {
	
	echo "<script>alert('Update successfully!...','self');window.location='adminevents.php';</script>";

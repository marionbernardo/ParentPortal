		...
		<div id="container">
			<div class="sidebar">
				<ul id="nav">
					...
					<li><a href="manage_student_balance.php" class="selected"><i class="fa fa-google-wallet" style="font-size:20px; color:white"></i>   Lendger Management</a></li>
			...
			<div class="content">
				...
				<li class="active">Lendger Management</a></li>
				</ol>			
					</div>
			...
			include("connection.php");
				...
				if(isset($_POST['submit'])) {
						...
						<td ><a href='update_amount_pay.php?student_no=<?php echo $row['student_no'];?>&grade_level=<?php echo 
						$row['grade_level'];?>'><input type="button" id="view" value="Update"></a></td>
						</tr>
						</tbody>

		...
		<div id="container">
			...
			<div class="content">
				...
				<li class="active">CMS</a></li>
					...
					<div id="pics">
					<div class="box-panel">
					<form action="adminannounce.php" method="POST" enctype="multipart/form-data">
					...
					<center>
						...
						<td><input type="text" name="what" required></td>
							</tr>

							<tr>
						<td align="right"><label>When(date/time) : </label></td>
						<td><input type="date" name="whendate"  required>
						...
						<td><input type="file" name="anphoto" id="file" required></td>
							</tr>
...
<td id="tb1"><label id="up" for="our-popup">Update the Announcement details</label>
			<span id="1">
	...
	<form action="updateanndet.php" method="POST">
		<table border=0  id="table-form2" cellspacing="10">
		<br>
				<tr>
					<td>
					&nbsp;&nbsp;&nbsp;&nbsp;Choose announcement title(what) :</td><td>	<select name="anni" required>
							<option value="">
					<?php
	...
	while ($row=mysql_fetch_array($run)){
		...
		?>
			<option value=<?php echo $anid; ?>><?php echo $what; ?></option>
	...
	<td id="tb1"><label id="up" for="our-popup1">Update the picture of announcement</label>
...
<span>
		...
		<div class="overlay-dialogue">
			<div id="boxtop">
				Update the picture of announcement
				<label id="labelclose" for="our-popup1">&nbsp;&nbsp;x&nbsp;&nbsp;</label>
			</div>
			
		<form action="updatephotoann.php" method="POST" enctype="multipart/form-data">
...
$file_path = $file['tmp_name'];
	...
	if(move_uploaded_file ($file_path,'images/'.$file_name))
		...
		$query = "insert into tb_announcements(ann_what,ann_when,ann_where,ann_photo) values ('$what','$date at $hour:$minute $med','$where','images/$file_name')";

 if(mysql_query($query)) {
	
	echo "<script>alert('Add successfully!...','self');window.location='adminannounce.php';</script>";

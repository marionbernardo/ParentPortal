...
$id = $_POST['faci'];
	...
	$query1 = "UPDATE tb_facilities SET facility_photo='images/$file_name' WHERE fid = '$id'";

	if(mysql_query($query1)) {
	
	echo "<script>alert('Update successfully!...','self');window.location='adminfacility.php';</script>";
